...
#import "ActionSheetPoolTimePicker.h"
#import "DistancePickerView.h"


@interface ActionSheetPoolTimePicker()
...
@property (nonatomic, copy) ActionSheetPoolTimePickerDoneBlock onActionSheetDone;
@property (nonatomic, copy) ActionSheetPoolTimePickerCancelBlock onActionSheetCancel;

@end

@implementation ActionSheetPoolTimePicker
...
+ (id)showPickerWithTitle:(NSString *)title bigUnitStrings:(NSArray *)bigUnitStrings bigUnitMax:(NSInteger)bigUnitMax selectedBigUnit:(NSInteger)selectedBigUnit smallUnitStrings:(NSArray*)smallUnitStrings smallUnitMax:(NSInteger)smallUnitMax selectedSmallUnit:(NSInteger)selectedSmallUnit doneBlock:(ActionSheetPoolTimePickerDoneBlock)doneBlock cancelBlock:(ActionSheetPoolTimePickerCancelBlock)cancelBlock origin:(id)origin {
    ...
    ActionSheetPoolTimePicker *picker = [[ActionSheetPoolTimePicker alloc] initWithTitle:title bigUnitStrings:bigUnitStrings bigUnitMax:bigUnitMax selectedBigUnit:selectedBigUnit smallUnitStrings:smallUnitStrings smallUnitMax:smallUnitMax selectedSmallUnit:selectedSmallUnit doneBlock:doneBlock cancelBlock:cancelBlock origin:origin];
...
+ (id)showPickerWithTitle:(NSString *)title bigUnitStrings:(NSArray *)bigUnitStrings bigUnitMax:(NSInteger)bigUnitMax selectedBigUnit:(NSInteger)selectedBigUnit smallUnitStrings:(NSArray*)smallUnitStrings smallUnitMax:(NSInteger)smallUnitMax selectedSmallUnit:(NSInteger)selectedSmallUnit target:(id)target action:(SEL)action origin:(id)origin {
    ActionSheetPoolTimePicker *picker = [[ActionSheetPoolTimePicker alloc] initWithTitle:title bigUnitStrings:bigUnitStrings bigUnitMax:bigUnitMax selectedBigUnit:selectedBigUnit smallUnitStrings:smallUnitStrings smallUnitMax:smallUnitMax selectedSmallUnit:selectedSmallUnit target:target action:action origin:origin];
    [picker showActionSheetPicker];
    return picker;
}
